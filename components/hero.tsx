    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="text-4xl  capitalize font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl text-balance">
          ...
          <p className="mt-6 text-lg leading-8 text-muted-foreground max-w-2xl mx-auto text-pretty">
            Upload images of skin conditions and get instant AI-powered
            analysis. Generate comprehensive patient reports and book
            appointments with dermatologists seamlessly.
          </p>

          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/patient/ai-report">
              <Button
                size="lg"
